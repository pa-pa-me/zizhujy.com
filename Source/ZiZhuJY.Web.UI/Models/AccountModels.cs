...
using ZiZhuJY.Web.UI.Resources.Models.Account;
...
namespace ZiZhuJY.Web.UI.Models
{
    ...
    public class LogOnModel
    {
        [Required]
        //[Display(Name = "用户名")]
        [LocalizedDisplayName("UserName", NameResourceType=typeof(AccountModels))]
        public string UserName { get; set; }

        [Required]
        [DataType(DataType.Password)]
        //[Display(Name = "密码")]
        [LocalizedDisplayName("Password", NameResourceType=typeof(AccountModels))]
        public string Password { get; set; }

        //[Display(Name = "记住我?")]
        [LocalizedDisplayName("RememberMe", NameResourceType=typeof(AccountModels))]
    ...
    public class AccountMembershipService : IMembershipService
    {
        ...
        //public MembershipProvider MembershipProvider { get { return this._provider; } }
