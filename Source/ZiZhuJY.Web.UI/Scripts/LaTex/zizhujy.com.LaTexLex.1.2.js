;(function() {
    ...
    // Usage:
    //  var tokenLexemeTable = zizhujy.com.LaTexLex.run(input);
    if (typeof zizhujy.com.LaTexLex == "undefined")
        zizhujy.com.LaTexLex = {
            ...
            // 考虑，故 function_name 项必须在 identifier 之前：
                FUNCTION_NAME: { value: -1, name: "Function Name", code: "sin", regex: /^(\\?sin|\\?cosec|\\?cos|\\?tan|\\?cot|\\?pow|\\?exp|sqrt|\\?sign|\\?log|\\?ln|\\?sec|\\?sgn|\\?arcsin|\\?arccos|\\?arctan|\\?arccot|\\?abs|\\?asin|\\?acos|\\?atan|\\?acot)$/ },
                CONSTANT_VALUE: { value: 0, name: "Constant Value", code: "PI", regex: /^(PI|\\PI|E|\\E|e|\\e|pi|\\pi)$/ },
                VARIABLE_NAME: { value: 1, name: "Variable Name", code: "x", regex: /^[a-zA-Z][a-zA-Z0-9]*$/ },
                DIGITAL_NUMBER: { value: 2, name: "Digital Number", code: "123`repetend`", regex: /^(\d+|\d*\.\d+(?:`\d+`)?|\d*.`\d+`)$/ },
                ...
                LATEX_NAME: { value: 10, name: "LaTex Name", code: "\\frac", regex: /^(\\frac|\\sqrt|\\cdot|\\left|\\right)$/ },
                ...
                LESS_THAN: { value: 20, name: "Less Than", code: "<", regex: /^<$/ },
                LATEX_NAME_OPEN_BRACE: { value: 21, name: "Open Brace inside LaTex command", code: "\\{", regex: /^\\\{$/ },
                LATEX_NAME_CLOSING_BRACE: { value: 22, name: "Closing Brace inside LaTex command", code: "\\}", regex: /^\\\}$/ },
                PIPE: { value: 23, name: "Pipe line", code: "|", regex: /^\|$/ },
                GREATER_THAN: { value: 24, name: "Greater Than", code: ">", regex: /^>$/ },
                LESS_THAN_OR_EQUAL_TO: { value: 25, name: "Less than or equal to", code: "\le ", regex: /^\\[Ll][Ee] ?$/ },
                GREATER_THAN_OR_EQUAL_TO: { value: 26, name: "Greater than or equal to", code: "\ge ", regex: /^\\[Gg][Ee] ?$/ 
}, 
        ...
        index: 0,
        // 前瞻现场缓存
        peekStore: {source: 0, index: 0, nextChar: "", lexeme: "", charClass: {value: 17, name: "Nonsense", code: "@"}}, 
        nextChar: "",
        lexeme: "",
            ...
            if(!this.eos()){
                ...
                switch(this.charClass){
                    ...
                    case (this.CharClassEnum.BACK_SLASH):
                        ...
                        if(this.charClass == this.CharClassEnum.LETTER){
                            this.addChar();
                            this.getChar();
        ...
        beginPeek: function(){            
            // Backup
            this.peekStore.source = this.source;
            this.peekStore.index = this.index;
            this.peekStore.nextChar = this.nextChar;
            this.peekStore.lexeme = this.lexeme;
            this.peekStore.charClass = this.charClass;
        },
        endPeek: function(){            
            this.source = this.peekStore.source;
            this.index = this.peekStore.index;
            this.nextChar = this.peekStore.nextChar;
            this.lexeme = this.peekStore.lexeme;
            this.charClass = this.peekStore.charClass;
        },
