...
; (function ($) {
    ...
    $.fn.bindToPlot = function (plot) {
        ...
        $(this).bind("change", function (event) {
            ...
            var command = "; plot.getOptions()" + expression + " = " + newValue + ";";
    ...
    function drawFlotOptionsStarterButton(plot, canvascontext) {
        ...
        var controlPanel = "<div class='flot-options-control-panel'>" +
                                    "<div class='popover-title'>" + localize("FlotOptionsPopUpTitle", "Options:") + "</div>" +
                                    "<div><form>" +
                                        "<label for='chk-show-legend'>" +
                                            "<input type='checkbox' id='chk-show-legend' expression='.legend.show' />" +
                                        " " + localize("FlotOptionsPopUp_ShowLegend", "Show Legend") + "</label>" +
                                    "</form></div>" +
                                "</div>";
    ...
    function localize(resourceLabel, defaultText) {
        if (Globalize && typeof Globalize.localize === "function") {
            return Globalize.localize(resourceLabel) || defaultText;
        } else {
            return defaultText;
        }
    }
