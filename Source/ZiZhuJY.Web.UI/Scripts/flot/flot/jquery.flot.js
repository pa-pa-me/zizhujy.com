...
(function($) {
        ...
        function setupTickGeneration(axis) {
            ...
            if (!axis.tickGenerator) {
                ...
                axis.tickGenerator = function(axis) {
                    ...
                    var ticks = [],
                        start = floorInBase(axis.min, axis.tickSize, Big),
                        i = 0,
                        v = Number.NaN,
                        prev;
                    ...
                    do {
                        ...
                        if (Big) {
                            v = Big(start).plus(Big(i).times(axis.tickSize)).toString();
                        }
                        ticks.push(v);
                        ++i;
    ...
    function floorInBase(n, base, big) {
        ...
        if (big) {
            var result = big(base).times(big(n).div(big(base)).round()).toString();
//
//            console.log('n = ' + n);
