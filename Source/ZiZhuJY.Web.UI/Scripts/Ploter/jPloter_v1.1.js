...
(function ($) {
    ...
    function jPloter(graphBoardId, inputBoardId, graphButtonId, resetButtonId, shareButtonId, linkButtonId, linkTextBoxId, statsDivId, chkLinearFitId, chkQuadraticFitId, chkCubicFitId, culture, percentageWidth, plotOptions) {
        this.config = {
