...
(function ($) {
    ...
    function jGraffiti(graphBoardId, inputBoardId, xMinId, xMaxId, yMinId, yMaxId, tMinId, tMaxId, pointsCountId, graphButtonId, resetButtonId, shareButtonId, linkButtonId, linkTextBoxId, culture) {
        this.config = {
        ...
        if (!this._initialized) {
            ...
            jGraffiti.prototype.buildUI = function () {
                ...
                this.ui.autoResize = function() {
                    ...
                    jG.ui.$GraphBoard.css("width", (parentWidth * 0.40) + "px");
                    jG.ui.$GraphBoard.css("height", (parentWidth * 0.40) + "px");
                        ...
                        switch (type) {
                            case FunctionItemType.fx:
                                ...
                                for (var i = x1; i <= x2; i += step) {
                                    ...
                                    if(i > x1) {
                                        var oldY = dataArr[dataArr.length - 1];
                                        if(oldY != null) {
                                            oldY = oldY[1];
                                        }

                                        if((oldY * y < 0) && (Math.abs(oldY - y) > this.options.sectionThreshold)) {
                                            dataArr.push(null);
                                        }
                                    }
