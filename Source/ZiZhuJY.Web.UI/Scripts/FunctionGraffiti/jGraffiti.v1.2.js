...
(function ($) {
    ...
    function jGraffiti(graphBoardId, inputBoardId, xMinId, xMaxId, yMinId, yMaxId, tMinId, tMaxId, pointsCountId, graphButtonId, resetButtonId, shareButtonId, linkButtonId, linkTextBoxId, culture, percentageWidth, plotOptions) {
        this.config = {
