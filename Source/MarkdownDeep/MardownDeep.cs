...
namespace MarkdownDeep
{
	...
	public class Markdown
	{
        ...
        // Callback to format a code span (ie: apply syntax highlighting)
        // string FormatCodeSpan(code)
        // Code = code content (ie: the code to format)
        // Return the formatted code, includeing <pre> and <code> tags
	    public Func<Markdown, string, string> FormatCodeSpan; 
